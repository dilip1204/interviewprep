...
public class UserJPAResource {
	...
	public List<Post> fetchAllUser(@PathVariable Integer id) {
	...
	@PostMapping("/jpa/createUser/{id}/posts")
	public ResponseEntity<Object> saveUser(@PathVariable Integer id, @RequestBody Post
			 post) {
		Optional<User> userOptional = userRepo.findById(id);
